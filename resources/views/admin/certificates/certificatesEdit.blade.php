                ...
                <section class="edit-about-section">
                    <div class="form-container">
                        ...
                        <form action="{{ route('certificates.update', $certificate->id) }}" method="POST"
                            ...
                            @method('PUT')
                            <label>Title:</label>
                            <input type="text" name="title" value="{{ old('title', $certificate->title) }}"><br>

                            <label>Issued By:</label>
                            <input type="text" name="issued" value="{{ old('issued', $certificate->issued) }}"><br>

                            <label>Issue Date:</label>
                            <input type="date" name="date" value="{{ old('date', $certificate->date) }}"><br>

                            <label>Description:</label>
                            <input type="text" name="description"
                                value="{{ old('description', $certificate->description) }}"><br>
