                    ...
                    <div class="form-container">
                        ...
                        <form action="{{ route('projects.update', $project->id) }}" method="POST"
                            ...
                            <input type="text" name="description"
                                value="{{ old('description', $project->description) }}"><br>

                            <label>Link:</label>
                            <input type="text" name="link" value="{{ old('link', $project->link) }}"><br>

                            <label>File:</label>
                            <input type="file" name="picture"><br><br>

                            <label>Current file:</label>
                            <img src="{{ Storage::url($project->picture) }}" style="width: 200px; height: 100px;"
                                alt=""><br><br>
