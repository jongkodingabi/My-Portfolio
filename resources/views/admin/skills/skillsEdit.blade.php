                                    ...
                                    <li>
                                        <div class="message-notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('asset-admin/assets/img/jm_denis.jpg') }}"
                                                            alt="Img Profile">
                                                    </div>
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('asset-admin/assets/img/chadengle.jpg') }}"
                                                            alt="Img Profile">
                                                    </div>
                                                    <div class="notif-content">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('asset-admin/assets/img/mlane.jpg') }}"
                                                            alt="Img Profile">
                                                    </div>
                                                    <div class="notif-content">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('asset-admin/assets/img/talha.jpg') }}"
                                                            alt="Img Profile">
                                                    </div>
                                                    <div class="notif-content">
                                    ...
                                    <li>
                                        <div class="notif-scroll scrollbar-outer">
                                            <div class="notif-center">
                                                ...
                                                <a href="#">
                                                    <div class="notif-img">
                                                        <img src="{{ asset('asset-admin/assets/img/profile2.jpg') }}"
                                                            alt="Img Profile">
                                                    </div>
                                                    <div class="notif-content">
                                                        <span class="block">
                                        ...
                                        <li>
                                            <div class="user-box">
                                                <div class="avatar-lg"><img
                                                        src="{{ asset('asset-admin/assets/img/profile.jpg') }}"
                ...
                <section class="edit-about-section">
                    <div class="form-container">
                        ...
                        <form action="{{ route('skills.update', $skill->id) }}" method="POST"
                            ...
                            @method('PUT')
                            <label>Title:</label>
                            <input type="text" name="title" value="{{ old('title', $skill->title) }}"><br>

                            <label>Description:</label>
                            <input type="text" name="link" value="{{ old('link', $skill->link) }}"><br>

                            <label>File:</label>
                            <input type="file" name="images"
                                value="{{ old('images', $skill->images) }}"><br><br>

                            <label>Current file:</label>
                            <img src="{{ Storage::url($skill->images) }}" style="width: 100px; height: 100px;"
                                alt=""><br><br>
