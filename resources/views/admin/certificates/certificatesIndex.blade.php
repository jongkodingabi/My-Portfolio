				...
				<!-- End Navbar -->
                        ...
                        <div class="container">
                            <div class="text-center mb-4">
                                ...
                                <h3 class="mb-3">Add Certificate</h3>
                                <a href="{{ route('certificates.create') }}" class="btn btn-success">Create Certificate</a>
                            </div>
                                ...
                                <table class="table table-hover table-striped" id="myTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($certificate->file)
                                                <a href="{{ Storage::url($certificate->file) }}" class="btn btn-primary btn-sm" target="_blank">View</a>
                                                @else
                                                    <span>No file uploaded</span>
                                                @endif
                                            </td>
                                            <td>
                                                <a href="{{ route('admin.certificates.certificatesShow', $certificate->id) }}" class="btn btn-info btn-sm">Detail</a>
                                                <a href="{{ route('admin.certificates.certificatesEdit', $certificate->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                                <form id="delete-form-{{ $certificate->id }}" action="{{ route('certificates.destroy', $certificate->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete({{ $certificate->id }})">Delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                        @endforeach
                            ...
                            <script>
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        Swal.fire("Certificate is not deleted", "", "info");
                                    }
                                });
                            }
                                </script>
