...
<html lang="en">
  <head>
    ...
    <link
      rel="icon"
      href="{{ asset('asset-admin/assets/img/kaiadmin/favicon.ico"
      type="image/x-icon"')}}"
    />
    ...
    <script>
      WebFont.load({
        ...
        custom: {
          ...
          urls: ["{{ asset('asset-admin/assets/css/fonts.min.css')}}"],
        },
        active: function () {
  ...
  <body>
    ...
    <script src="{{ asset('asset-admin/assets/js/setting-demo.js')}}"></script>
