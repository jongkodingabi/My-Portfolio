                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <p><strong>Link:</strong> <a href="{{ $project->link }}" target="_blank">Click here</a></p>
                                    <p><strong>Date:</strong> {{ $project->date }}</p>

                                    @if ($project->picture)
                                        <p><strong>File:</strong>
                                            <a href="{{ Storage::url($project->picture) }}" class="btn btn-outline-primary btn-sm">
                                                See Project
                                            </a>
                                        </p>
                                    @endif
                                ...
                                <div class="card-footer">
                                    <a href="{{ route('admin.projects.projectIndex') }}" class="btn btn-secondary">
                                        Back
                                    </a>
                                </div>
                            </div>
