            ...
            <section class="padding-bottom: 3px;">
                <section class="edit-about-section">
                    <div class="form-container">
                        ...
                        <form action="{{ route('heroSections.update', $heroSection->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <img src="{{ Storage::url($heroSection->picture) }}" width="100" alt="Current Picture">
