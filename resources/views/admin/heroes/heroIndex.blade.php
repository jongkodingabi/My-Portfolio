				...
				<!-- End Navbar -->
                        ...
                        <div class="container">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form id="delete-form-{{ $heroSection->id }}" action="{{ route('heroSectionsCollections.destroy', $heroSection->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete({{ $heroSection->id }})">Delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                        @endforeach
                            ...
                            <script>
                                ...
                                {{-- Confirm Alert --}}
                                <script>
                                    function confirmDelete(heroSectionId) {
                                Swal.fire({
                                    title: "Are you sure?",
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        document.getElementById("delete-form-" + heroSectionId).submit();
                                        Swal.fire({
                                            title: "Deleted!",
                                        ...
                                        Swal.fire("Hero is not deleted", "", "info");
                                    }
                                });
                            }
                                </script>
